...
public class Plateau implements Serializable {
    ...
    //on verifie si ine colonne contient au moins un BlocIncassable
    ...
    public boolean fini() {
        ...
        for (int i = 0; i < hauteur; i++) {
            for (int j = 0; j < largeur; j++) {
                if (cases[i][j] != null) {
                    if (!(cases[i][j] instanceof BlocIncassable))
                        return false;
                }
            }
        }
